          ...
          <div className="rounded-2xl bg-white w-full max-w-2xl flex flex-col justify-between items-center shadow-none md:shadow-lg px-4 py-6 md:p-8">
            ...
            <div className="flex justify-between items-center w-full pt-4 border-t">
              ...
              <button
                ...
                className={`px-6 py-2.5 text-white rounded-lg items-center gap-2 transition-colors bg-[#F9CA44] hover:bg-[#f0c143]} ${
                  currentStep !== steps.length ? "flex" : "hidden"
                }`}
              >
                {" "}
                Next
              ...
              <button
                ...
                className={`px-6 py-2.5 text-white rounded-lg items-center gap-2 transition-colors bg-green-500 hover:bg-green-600 ${
                  currentStep === steps.length ? "flex" : "hidden"
                }`}
              >
                Checkout Order
